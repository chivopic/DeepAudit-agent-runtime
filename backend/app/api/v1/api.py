...
from app.api.v1.endpoints import auth, users, projects, tasks, scan, members, config, database, prompts, rules, agent_tasks, embedding_config, ssh_keys, graph_audits
...
# Additive LangGraph dual-path (M4); FE default remains agent-tasks
api_router.include_router(graph_audits.router, prefix="/graph-audits", tags=["graph-audits"])
